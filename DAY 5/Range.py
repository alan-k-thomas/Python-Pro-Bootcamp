...
# The combination of the range() function with the Python.
# For Loop allows us to run a loop for as many times as we wish. 
...
# This code doesn't do anything by itself. For example, 
# if you tried to print it, it would not give you individual numbers.
...
# Step 1: Add an accumulator
total = 0 

# Step 2: Creating loop
for number in range(1, 101): # If we add another range (1, 101, 3) - the counting will steps up by 3
    total += number # Accumulator += i 
print(total)
